...
class DeviceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if (getUserPlanData('device_limit') == false) {
            return response()->json([
                'message'=>__('Limite máximo de dispositivos excedido')
            ],401);  
        }
        ...
        return response()->json([
            ...
            'message'=>__('Dispositivo criado com sucesso')
        ],200);
    }
    ...
    public function getQr($id)
    {
        ...
        elseif($response->status() == 409){
            $data['qr']      =$device->qr;
            $data['message'] = __('QR Code recebido, escaneie o QR Code');
            return response()->json($data);
        }
    }
    ...
    public function webHook(Request $request,$device_id)
    {
       ...
       if (empty($device)) {
        return response()->json([
            'message'  => array('text' => 'esta é a resposta'),
    ...
    public function logoutSession($id)
    {
      ...
      return response()->json(['message'=>__('Seu dispositivo foi deslogado com sucesso')]);
    ...
    public function update(Request $request, $id)
    {
        ...
        return response()->json([
            ...
            'message'=>__('Dispositivo atualizado com sucesso')
        ],200);
    }
    ...
    public function destroy($id)
    {
        ...
        return response()->json([
            'message' => __('Seu dispositivo foi removido com sucesso'),
