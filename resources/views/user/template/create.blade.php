...
@include('layouts.main.headersection',['title'=> 'Create Template','buttons'=>[
    [
        'name'=>'<i class="fas fa-step-backward"></i> &nbspVoltar',
                        ...
                        <ul class="nav nav-pills flex-column" id="myTab4" role="tablist">
                            ...
                            <li class="nav-item mt-2">
                                <a class="nav-link" id="profile-tab4" data-toggle="tab" href="#mode_4" role="tab" aria-controls="profile" aria-selected="false">
                                    {{ __('Modelo de Mensagem') }} <small class="text-danger">{{ __('(Beta)') }}</small>
                                </a>
                            </li>
                            <li class="nav-item mt-2">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <ul class="list-group list-group-flush">
          ...
          <li class="list-group-item"><p><b>Nota: </b>Se você deseja um parâmetro personalizado para API. Use <strong>{1}</strong>, o limite máximo do parâmetro é 20. Como <strong>{1},{2},{3},.....,{20}</strong> <br> Exemplo : você fez uma compra por <b>{1}</b> usando um cartão de crédito com final <b>{2}</b></p></li>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-neutral" data-dismiss="modal">Fechar</button>
      </div>
    </div>
  </div>
</div>
